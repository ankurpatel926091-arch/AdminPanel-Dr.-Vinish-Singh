...
export default function Blogs() {
  ...
  // Notification Toast
  const [toastNotice, setToastNotice] = useState({ show: false, message: '', type: 'success' });
  ...
  const showToast = (message, type = 'success') => {
    setToastNotice({ show: true, message, type });
    if (type === 'error') {
      toast.error(message);
    } else if (type === 'info') {
      toast.info(message);
    ...
    setTimeout(() => setToastNotice({ show: false, message: '', type: 'success' }), 4000);
  };
